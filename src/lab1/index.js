...
function showEntry() {
  rl.question(entryMsg, answer => {
    switch (answer) {
      case "1":
        try {
          let noiseObjects = fs.readFileSync("./src/lab1/src/teach.txt");
      ...
      case "2":
        try {
          let noiseObjects = fs
            .readFileSync("./src/lab1/src/teach.txt")
            .toString()
            .split("\n");
      ...
      case "5":
        ...
        fs.writeFileSync(
          "./src/lab1/src/teach.txt",
          _.shuffle(content).join("\n"),
          {
            flag: "w"
          }
        );
        fs.writeFileSync(
          "./src/lab1/src/exam.txt",
          _.shuffle(content)
            .map(elem => {
